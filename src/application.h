...
int send_control_block(int fd, int C, char *file_size, char *filename);
int receive_control_block(int fd, int ctrl, int *file_length, char **filename);

int send_data_block(int fd, int N, const char *buf, int length);
int receive_data_block(int fd, int *N, char **buf, int length);
